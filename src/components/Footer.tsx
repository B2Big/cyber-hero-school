        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div>
            ...
            <div className="flex justify-center gap-6">
              ...
              >
                ...
                <span className="text-foreground font-semibold">YouTube</span>
              </a>
              <a 
          ...
          <div className="max-w-2xl mx-auto p-6 border-l-4 border-primary bg-card/50 rounded-r-xl">
            <p className="text-xl italic text-foreground/90">
              « Une expérience ludique qui aborde intelligemment le harcèlement scolaire. »
            </p>
          </div>
          ...
          <div className="pt-8 border-t border-border">
            <p className="text-sm text-muted-foreground">
              © 2025 Pixel Hero School - Tous droits réservés
            </p>
